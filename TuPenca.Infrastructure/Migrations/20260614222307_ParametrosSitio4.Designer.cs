...
namespace TuPenca.Infrastructure.Migrations
{
    ...
    [Migration("20260614222307_ParametrosSitio4")]
    partial class ParametrosSitio4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TuPenca.Domain.Entities.ParametrosSitio", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("DiaResumenSemanal")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("HoraResumenSemanal")
                        .HasColumnType("int");

                    b.Property<int>("HorasAntesRecordatorio")
                        .HasColumnType("int");

                    b.Property<bool>("NotifRecordatorioPrediccion")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifResultadoPartido")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifResumenSemanal")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TuPenca.Domain.Entities.ParametrosSitio", b =>
                {
                    b.HasOne("TuPenca.Domain.Entities.Sitio", "Sitio")
                        .WithOne("Parametros")
                        .HasForeignKey("TuPenca.Domain.Entities.ParametrosSitio", "SitioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
